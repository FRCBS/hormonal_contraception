...
bb="-7.123,-7.75,6.586,6.759"

"Blood donation" [latent,pos="-5.981,-1.149"]

"Contraindication for HC use" [pos="2.970,2.824"]

"Eating disorder" [pos="-1.662,-6.541"]

"Education level" [pos="1.238,-4.346"]

"Gastrointestinal blood loss" [latent,pos="-4.193,3.364"]

"HC use and type" [exposure,pos="1.638,-0.677"]

"Increased iron demand" [latent,pos="-5.666,0.827"]

"Iron deficiency anemia" [outcome,pos="-2.220,-0.062"]

"Iron intake" [latent,pos="-2.177,-4.085"]

"Place of residence" [pos="5.444,-1.886"]

"Thrombosis/embolism" [pos="-0.539,3.811"]

AUB [pos="3.073,-2.242"]

Age [pos="0.585,1.249"]

Cancer [pos="-0.888,1.120"]

Hypertension [pos="1.660,4.705"]

Hypothyroidism [pos="-3.943,-2.683"]

IBD [pos="-1.960,5.550"]

Income [pos="3.828,-3.830"]

Inflammation [latent,pos="1.195,2.585"]

MBO [pos="4.502,4.040"]

Menstruation [latent,pos="-0.614,-3.262"]

Obesity [latent,pos="4.302,0.872"]

Pregnancy [pos="-0.362,-2.165"]

Smoking [latent,pos="-0.701,2.428"]

"Blood donation" -> "Iron deficiency anemia"

"Contraindication for HC use" -> "HC use and type"

"Eating disorder" -> "Iron intake"

"Eating disorder" -> Menstruation
...
"HC use and type" -> "Iron deficiency anemia"

"HC use and type" -> Inflammation

"HC use and type" -> Menstruation

"HC use and type" -> Pregnancy

"Increased iron demand" -> "Iron deficiency anemia"

"Iron deficiency anemia" -> "Thrombosis/embolism"

"Iron intake" -> "Iron deficiency anemia"

"Place of residence" -> "HC use and type"

"Thrombosis/embolism" -> "Contraindication for HC use"
...
Age -> "Iron deficiency anemia"

Age -> Hypertension

Age -> Inflammation

Cancer -> "HC use and type"

Cancer -> "Iron deficiency anemia"

Cancer -> "Thrombosis/embolism"

Hypertension -> "Contraindication for HC use"
...
IBD -> "Gastrointestinal blood loss"
...
Inflammation -> "Iron deficiency anemia"

Inflammation -> Cancer

MBO -> Inflammation

Menstruation -> "Iron deficiency anemia"

Obesity -> "HC use and type"
...
Smoking -> "HC use and type"

Smoking -> "Thrombosis/embolism"
...
paths(g, "HC use and type", "Iron deficiency anemia")
```
```{r}
...
adjustmentSets(g,"HC use and type","Iron deficiency anemia")

```

Dagitty desktop: "Model contains cycle: Iron deficiency anemia→Thrombosis/embolism→Contraindication for HC use→HC use and type→Iron deficiency anemia"

## Remove the pathways between IDA and thrombosis/embolism + HC and inflammation, we end up with: 

Is there grounds for removing pathways? Recheck literature
...
```
 Dagitty desktop: "Biasing paths are open. No adjustment sets found." So this set does not work. Try removing later variables (adjust) to find where the issue is. Likely something in the inflammation/thrombosis downlines?