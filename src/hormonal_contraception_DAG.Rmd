...
-remove the old part as separate script
...
-what do we do with age and time ? Can we break loops with some timing?
  ...
  -yes, you get 0.5 kg per weight so the older you are the more likely have some chronic inflammation?
  ...
  -but Eeva said
    ...
    -for progesterone pills age should not matter
...
pastricha_dag_mens <- ggdag::dagify(
  ...
  HC ~ Age, # age affect your choice of contraception
  Iinfl ~ Age, # the older you are the more inflamed you get
